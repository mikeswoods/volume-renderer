...
namespace glm
{
	...
	GLM_FUNC_QUALIFIER detail::tvec3<T, P> Color(const detail::tvec3<T, P>& hsvColor)
	{
		detail::tvec3<T, P> hsv = hsvColor;
		detail::tvec3<T, P> Color;

		if(hsv.y == static_cast<T>(0))
			// achromatic (grey)
			Color = detail::tvec3<T, P>(hsv.z);
		else
		{
	...
	template <typename T, precision P>
	GLM_FUNC_QUALIFIER detail::tvec3<T, P> hsvColor(const detail::tvec3<T, P>& Color)
	{
		detail::tvec3<T, P> hsv = Color;
		...
		if(Max != static_cast<T>(0))
		{
			...
			if(Color.r == Max)
				...
				h = static_cast<T>(0) + T(60) * (Color.g - Color.b) / Delta;
			else if(Color.g == Max)
				// between cyan & yellow
				h = static_cast<T>(120) + T(60) * (Color.b - Color.r) / Delta;
			else
				// between magenta & cyan
				h = static_cast<T>(240) + T(60) * (Color.r - Color.g) / Delta;
